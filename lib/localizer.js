...
function sortEvents(_ref) {
  var _ref$evtA = _ref.evtA,
    ...
    aZIndex = _ref$evtA.zIndex,
    _ref$evtB = _ref.evtB,
    bStart = _ref$evtB.start,
    bEnd = _ref$evtB.end,
    bAllDay = _ref$evtB.allDay,
    bZIndex = _ref$evtB.zIndex
  var startSort =
  ...
  var zIndex = zIndexSort(aZIndex, bZIndex)
  return (
    startSort ||
...
var DateLocalizer = /*#__PURE__*/ (0, _createClass2.default)(
...
function mergeWithDefaults(localizer, culture, formatOverrides, messages) {
  var formats = (0, _objectSpread2.default)(
    (0, _objectSpread2.default)({}, localizer.formats),
    formatOverrides
  )
  return (0, _objectSpread2.default)(
    (0, _objectSpread2.default)({}, localizer),
    {},
    {
      messages: messages,

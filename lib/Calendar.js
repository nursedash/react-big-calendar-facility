...
var Calendar = /*#__PURE__*/ (function(_React$Component) {
  ...
  _proto.getContext = function getContext(_ref2) {
    var startAccessor = _ref2.startAccessor,
      ...
      zIndexAccessor = _ref2.zIndexAccessor,
    ...
    return {
      ...
      accessors: {
        ...
        zIndex: (0, _accessors.wrapAccessor)(zIndexAccessor)
      },
    }
  }
...
Calendar.propTypes =
  process.env.NODE_ENV !== 'production'
    ? {
        ...
        /**
         * Accessor for the event zIndex, used for custom sorting. Should
         * resolve to a `renderable` value.
         *
         * ```js
         ...
         * @type {(func|number)}
         */
        zIndexAccessor: _propTypes2.accessor,
